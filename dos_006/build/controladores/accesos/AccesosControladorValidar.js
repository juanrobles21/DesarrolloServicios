...
const accesos_crear_sql_1 = require("../../repositorios/accesos/accesos_crear_sql");
class AccesosControladorValidar extends AccesosDaoValidar_1.default {
    validarAcceso(req, res) {
        ...
        AccesosControladorValidar.validarAcceso(accesos_crear_sql_1.SQL_ACCESOS_VALIDAR.VALIDAR, parametro, res);
    }
}
