    ...
    static procesar(registro, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (registro != null) {
                ...
                const miTockencito = jsonwebtoken_1.default.sign({ nombre: registro.nombresUsuario, apellidos: registro.apellidosUsuario, rol: registro.nombreRol, dosDev: 'eso somos' }, 'uyyyyLaclave', { expiresIn: '8h' });
